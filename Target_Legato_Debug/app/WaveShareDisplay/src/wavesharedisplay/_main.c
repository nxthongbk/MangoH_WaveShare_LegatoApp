...
// Startup code for the executable 'wavesharedisplay'.
...
LE_SHARED le_log_SessionRef_t wavesharedisplay_exe_LogSession;
LE_SHARED le_log_Level_t* wavesharedisplay_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wavesharedisplay_exe_LogSession = log_RegComponent("wavesharedisplay_exe", &wavesharedisplay_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_WaveShareDisplayComponent.so");
